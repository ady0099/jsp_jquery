 ...
 * Generated at: 2023-07-26 07:13:20 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("					var idx =$(this).find(\"idx\").text();\r\n");
      out.write("					var id =$(this).find(\"id\").text();\r\n");
      out.write("					var pw =$(this).find(\"pw\").text();\r\n");
      out.write("					var name =$(this).find(\"name\").text();\r\n");
      out.write("					var age =$(this).find(\"age\").text();\r\n");
      out.write("					var reg =$(this).find(\"reg\").text();\r\n");
      out.write("					\r\n");
      out.write("					tbody +=\"<tr>\";\r\n");
      out.write("					tbody +=\"<td>\"+idx+\"</td><td>\"+id+\"</td>\";\r\n");
      out.write("					tbody +=\"<td>\"+pw+\"</td><td>\"+name+\"</td><td>\"+age+\"</td><td>\"+reg+\"</td>\";\r\n");
      out.write("					tbody +=\"<td><button type='button' id='del' name='\"+idx+\"'>삭제</button></td>\";\r\n");
      out.write("					//tbody +=\"<td><input type='button' value='삭제' id='del' name='\"+idx+\"'></td>\";\r\n");
      out.write("					\r\n");
      out.write("					tbody +=\"</tr>\";\r\n");
      out.write("				});\r\n");
      ...
      out.write("			success : function(data){\r\n");
      out.write("				if($(\"#m_id\").val().length<=3){\r\n");
      out.write("					$(\"#dup\").css(\"color\",\"red\");\r\n");
      out.write("					$(\"#dup\").text(\"ID는 4글자 이상이어야합니다.\");\r\n");
      out.write("				}else{	\r\n");
      out.write("					if(data >= 1){\r\n");
      out.write("						//console.log(\"사용불가\");\r\n");
      out.write("						$(\"#dup\").css(\"color\",\"red\");\r\n");
      out.write("						$(\"#dup\").text(\"사용 중인 ID입니다.\");\r\n");
      out.write("						$(\"#btn\").attr(\"disabled\", \"disabled\");\r\n");
      out.write("					}else if( $(\"#m_id\").val().match(\"admin\")){\r\n");
      out.write("						$(\"#dup\").css(\"color\",\"red\");\r\n");
      out.write("						$(\"#dup\").text(\"사용 불가능한 문자가 포함되어있습니다.\");\r\n");
      out.write("						$(\"#btn\").attr(\"disabled\", \"disabled\");\r\n");
      out.write("					}else{\r\n");
      out.write("						//console.log(\"사용가능\");\r\n");
      out.write("						$(\"#dup\").css(\"color\",\"green\");\r\n");
      out.write("						$(\"#dup\").text(\"사용가능한 ID입니다.\");\r\n");
      ...
      out.write("	\r\n");
      out.write("	// 회원가입\r\n");
      out.write("	// form을 이용해서 데이터를 전달할 때는 직렬화(serialize())를 해야 된다.\r\n");
      ...
      out.write("			<tbody>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td><input type=\"text\" size=\"16\" name=\"m_id\" id=\"m_id\" /><br>\r\n");
      out.write("						<span id=\"dup\">중복여부</span></td>\r\n");
      out.write("					<td><input type=\"password\" size=\"16\" name=\"m_pw\" /></td>\r\n");
      out.write("					<td><input type=\"text\" size=\"16\" name=\"m_name\" /></td>\r\n");
      out.write("					<td><input type=\"text\" size=\"16\" name=\"m_age\" /></td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</tbody>\r\n");
      out.write("			<tfoot>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td colspan=\"7\" align=\"center\"><button type=\"button\" id=\"btn\" disabled>가입하기</button></td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</tfoot>\r\n");
      out.write("		</table>\r\n");
      out.write("	</form>\r\n");
